# Workspace Zero
This workspace shows that OSS workspace produced by `dlt init` can be deployed without any changes and will work just fine on the runtime.
1. `.dlt/.workspace` enables runtime commands

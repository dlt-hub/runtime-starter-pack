...
if __name__ == "__main__":
    ...
    jaffle_transform_pipe = dlt.pipeline("jaffle_transform", destination="jaffleshop_transformation_destination")
    transform_load_info = jaffle_transform_pipe.run(customers_metrics(jaffle_ingest_pipe.dataset()))

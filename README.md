...
2. A remote destination configured as MotherDuck. You can swap it for any other cloud destination you prefer (for example
   ...
   [AWS S3](https://dlthub.com/docs/dlt-ecosystem/destinations/filesystem.md), …).
...
Details on configuring credentials for Runtime are available [here](https://dlthub.com/docs/devel/hub/runtime/overview#credentials-and-configs).
...
> Getting MotherDuck Credentials
...
> For a full list of available commands and options, see the [Runtime CLI reference](https://dlthub.com/docs/devel/hub/runtime/overview#common-commands).
...
> Read more about profiles in the [Runtime profiles docs](https://dlthub.com/docs/devel/hub/runtime/overview#profiles).
...
You can find full details in the [Transformations](https://dlthub.com/docs/devel/hub/features/transformations/index) documentation. Below are a few core patterns to get you started.
...
> ```
> You can find more details in the [license section](https://dlthub.com/docs/devel/hub/getting-started/installation#self-licensing) of the docs.
